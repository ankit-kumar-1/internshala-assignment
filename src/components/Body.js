        ...
        <div className="flex z-10 flex-col mt-0 max-w-full w-[1090px]">
          <div className="flex flex-col px-7 max-md:px-5 max-md:max-w-full">
            <div className="flex flex-col pt-12 pb-2.5 ml-3 bg-gray-50 max-md:max-w-full">
              ...
              <div className="flex gap-5 justify-between items-start mt-2.5 w-full text-sm leading-5 max-md:flex-wrap max-md:max-w-full">
                <div className="flex gap-0.5 mt-1.5 text-gray-600 max-md:flex-wrap max-md:max-w-full">
                  <img alt=""
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/44c2b31f6f63e2adfc5de5ab18d8fb1554b6c8bcd36d0c1fe3091566c2a4ffa1?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                    className="w-5 aspect-square"
                  />
                  <div>Last Updated</div>
                  <div className="my-auto">-</div>
                  <div className="flex-auto text-sm leading-5 pr-2">
                    February 22, 2020
                  </div>
                  <img alt=""
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/33d3213079efdce9cee37800c05e3e006d1d2c0076c5e8328ee1a81932daf13d?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                    className="w-5 aspect-square"
                  />
                ...
                <div className="flex gap-1.5 text-center text-gray-500 whitespace-nowrap">
                  ...
                  <img alt=""
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/d5e182ca72f86d5b7c0ff998726dfa8cc2ad82f819199d3e2bc74b4ea1bad1e9?apiKey=f7955b557b1c414699668cfd8849ecc3&"
            ...
            <div className="flex gap-2.5 items-center self-start mt-5 text-sm leading-5 text-gray-500 max-md:flex-wrap max-md:max-w-full">
              ...
              <img alt=""
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/22dba1a57915cd7bfe181eb93e776ce2caedc04c95e1d64a961f066c8d3e498b?apiKey=f7955b557b1c414699668cfd8849ecc3&"
          ...
          <div className="flex gap-0 justify-between mt-11 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
            <div className="z-10 flex  justify-center items-center px-6 mt-8 text-xl leading-7 text-gray-500 whitespace-nowrap bg-white rounded-full border border-solid aspect-[1.05] border-zinc-200 border-opacity-0 h-[45px] max-md:pr-5">
              1
            </div>
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                <div className="flex flex-col w-[23%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col mt-0 max-md:mt-2.5">
                    <div className="flex gap-2 justify-between px-3 py-2 text-base leading-6 text-white bg-orange-500 w-2/3 rounded-r-xl">
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/7306664779ae5765ddf4dcc1d9f9d0804bde18d831eadcc46bc3ac6cfa1255bf?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                        className="w-5 aspect-square"
                      />
                ...
                <div className="flex flex-col ml-5 w-[24%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col whitespace-nowrap max-md:mt-6">
                    <div className="flex flex-col self-center px-8 pt-1 pb-5 max-w-full text-sky-800 bg-sky-50 rounded-none w-[145px] max-md:px-5">
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/fd21800d3b91349927d386e5202068bc87da108686b40930b980f861266f361a?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                      ...
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/775f970be52707584d29ea39d9d429412655498548c7a26ec93ece196aea8766?apiKey=f7955b557b1c414699668cfd8849ecc3&"
          ...
          <div className="flex gap-0 justify-between mt-5 max-md:flex-wrap max-md:max-w-full">
            ...
            <div className="pr-7 pb-3 bg-white rounded-xl max-md:max-w-full">
              <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                <div className="flex flex-col w-[23%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col mt-0 max-md:mt-2.5">
                    <div className="flex gap-2 justify-between px-3.5 py-2 text-base leading-6 text-white bg-orange-500 w-2/3 rounded-r-xl">
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/2331e4b51e73fc12559c9fbe1094d0e157beedfcc39b3a283ec535c6323fa9ee?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                        className="w-5 aspect-square"
                      />
                ...
                <div className="flex flex-col ml-5 w-[24%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col whitespace-nowrap max-md:mt-6">
                    <div className="flex flex-col self-center px-9 pt-1 pb-5 max-w-full text-sky-800 bg-sky-50 rounded-none w-[145px] max-md:px-5">
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/095a824aea11916565b84cda43b60ada51254ee9e0a0ca7fb7b1959aa44cc591?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                        className="self-end w-2.5 aspect-square"
                      />
                      <div className="self-center mt-1.5 text-3xl leading-10">
                        9.5
                      ...
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/dd8a17259dc74fd8f0f83e3644bcce11994fe055aeba9beada443dd272f3b2f4?apiKey=f7955b557b1c414699668cfd8849ecc3&"
          ...
          <img alt=""
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/317ae1683e316ad70eb4e4e35cb5bc00f3b50b12d2f63811ad4b245c884ce08f?apiKey=f7955b557b1c414699668cfd8849ecc3&"
            className="self-end mt-6 mr-36 w-2.5 aspect-square max-md:mr-2.5"
          />
          <div className="flex gap-0 justify-between mt-1 max-md:flex-wrap max-md:max-w-full">
            <div className="z-10 flex  justify-center items-center px-5 mt-7 text-xl leading-7 text-gray-500 whitespace-nowrap bg-white rounded-full border border-solid aspect-[1.05] border-zinc-200 h-[45px]">
              3
            </div>
                ...
                <div className="flex flex-col ml-5 w-[26%] max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col whitespace-nowrap max-md:mt-6">
                    <div className="flex flex-col items-center self-center px-8 py-5 max-w-full text-sky-800 bg-sky-50 rounded-none w-[145px] max-md:px-5">
                      ...
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/62af5d46e79744366108c30cc8adc0f06c419316e254bcb96fffb0c8505dc381?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                  ...
                  <div className="flex flex-col grow mt-7 max-md:mt-10 max-md:max-w-full">
                    <div className="flex flex-col max-md:max-w-full">
                      ...
                      <div className="flex gap-2 self-start mt-3 text-base leading-6 text-gray-600 capitalize whitespace-nowrap">
                        <img alt=""
                          loading="lazy"
                          src="https://cdn.builder.io/api/v1/image/assets/TEMP/90cb9db22dfef0f92a4ccd0e568907e8007672a69bc616d8beee27256c4f38b7?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                          className="w-6 aspect-square"
                        />
                ...
                <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                  <div className="flex flex-col grow items-center whitespace-nowrap max-md:mt-8">
                    <div className="flex flex-col items-center px-8 py-4 max-w-full text-sky-800 bg-sky-50 rounded-none w-[135px] max-md:px-5">
                      ...
                      <img alt=""
                        loading="lazy"
                        src="https://cdn.builder.io/api/v1/image/assets/TEMP/0d2545f9105753a67caa650a5f5d2382fa3cfd92920f016d5fb0047d86f7b5ac?apiKey=f7955b557b1c414699668cfd8849ecc3&"
                        className="mt-2.5 w-full aspect-[6.67]"
                      />
                    </div>
                    <img alt=""
                      loading="lazy"
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/bdaceae227ce58caed4cd345603502b572eb0005ee06b0658f20ddab61692cee?apiKey=f7955b557b1c414699668cfd8849ecc3&"
          ...
          <img alt=""
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/f863181b166566a96cc261aa9fd2c584da20526678b9ffb270f104025506234e?apiKey=f7955b557b1c414699668cfd8849ecc3&"
              ...
              <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                ...
                <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                  <div className="flex gap-0 text-sm tracking-wider leading-5 text-center text-white whitespace-nowrap max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
                    <input type="text" className="max-w-full bg-white h-[52px] w-[348px] text-black" />
                    <div className=" flex items-center justify-center px-5 py-2 rounded-r-xl bg-blue-500 max-md:px-5">
                      Sign Up
                    </div>
                  </div>
                </div>
